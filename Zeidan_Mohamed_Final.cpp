...
//
////If the player decides to play against a bot, it does not loop. I've tried my hardest to try and make it loop but it just wouldn't loop.
//
//#include <iostream>
//#include <cstdlib>
//#include <iomanip>
...
//						cout << "Tom" << endl;
//						cout << "--------------\n";
//						cout << setw(3) << fixed << "Wins: " << tom.win << endl;
//						cout << setw(3) << fixed << "Losses: " << tom.lose << endl;
//						cout << setw(3) << fixed << "Ties: " << tom.tie << endl << endl;
//
//						cout << "Would you like to start the game? (y or n): ";
//						cin >> playAgain;
//
